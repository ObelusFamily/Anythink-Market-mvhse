...
const API_ROOT =
  process.env.NODE_ENV !== "production"
    ? "https://aaronosher-obelusfamily-anythink-market-mvhse-7q6x4vwhwgw-3000.githubpreview.dev/api"
...
const Items = {
  all: (page, titleQuery='') => requests.get(`/items?${limit(1000, page)}${title(titleQuery)}`),
